    ...
    <Box>
      ...
      <Flex className={styles.loginBox}>
        <VStack gap={"10px"} color="#7c7c7c">
          ...
          <Text textDecoration={"underline"} className={styles.newsSubHead}>
            Login with SSO
          </Text>
          <Text textDecoration={"underline"} className={styles.newsSubHead}>
            Reset password
      ...
      <Stack mt={"100px"}>
        <Box>
          ...
          <Text className={styles.subHead} mt="0px">
            Try Everhour for free and see if it works for your business
          </Text>
        </Box>
      </Stack>
      <Flex m="auto" mt={"30px"} width={"470px"} gap={"10px"}>
      ...
      >
        ...
        <Text fontSize={"1.25rem"} color="#767676">
