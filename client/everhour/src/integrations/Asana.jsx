...
import { asanaRightImageData1,asanaRightImageData2,asanaRightImageData3,asanaRightImageData4,asanaRightImageData5 } from "./Data/Asana/AsanaRightImageData";
import { asanaLeftImageData1,asanaLeftImageData2,asanaLeftImageData3,asanaLeftImageData4 } from "./Data/Asana/AsanaLeftImageData";
...
const Asana = () => {
  ...
  return (
    <Box >
      <Box width={"80%"} m="auto">
        <Box >
        <Heading fontSize={"45px"} fontWeight="400">Asana time tracking integration</Heading>
      <Text color={"grey"} fontSize={"25px"} fontWeight="400">
      Time tracking in Asana with timesheets, budgeting, client reporting, and payroll. Works inside Asana. No more tab switching!
      </Text>
      <Button
        variant="outline"
        colorScheme="green"
