      ...
      <Box width={"80%"} m="auto">
        <Box>
          ...
          <Text color={"grey"} fontSize={"25px"} fontWeight="400">
            ...
            and payroll. Works inside Basecamp. No more tab switching!
          </Text>
          <Button
            variant="outline"
            colorScheme="green"
        ...
        <Box w={"70%"} m="100px auto 50px auto " textAlign={"left"}>
        ...
        <Box>
          ...
          <Text
            ...
            fontWeight={"100"}
          >
            A smoothly synced Everhour time tracking app with Basecamp 3 enables
            your project team with the advanced time tracking functionality
            close at hand. Here is how it works.
          </Text>
          <List w={"70%"} m="auto">
            <ListItem
              textAlign={"left"}
            ...
            >
              ...
              <Text fontSize={"16px"} p="0px 40px" fontWeight={"100"}>
                When you sign up, Everhour will automatically sync tasks from
                your projects. Sync happens periodically so all new tasks that
                you create in Basecamp will be visible in Everhour reports.
                Everhour also updates the names of tasks or projects if they
                were renamed in Basecamp. This way Everhour reports will always
                show you the freshest data.
              </Text>
            </ListItem>
            ...
            >
              ...
              <Text fontSize={"16px"} p="0px 40px" fontWeight={"100"}>
                After successful integration, you can track time using the timer
                or log time manually. You’ll see the time reported by each
                employee and its progress.
              </Text>
            ...
            >
              ...
              <Text fontSize={"16px"} p="0px 40px" fontWeight={"100"}>
                You don't necessarily need to open Basecamp or Everhour
                websites. By clicking on the timer icon in the browser toolbar
                you can quickly start the timer, add time to any task, edit time
                or estimate, and more.
              </Text>
            ...
            >
              ...
              <Text fontSize={"16px"} p="0px 40px" fontWeight={"100"}>
                ...
                from Basecamp. Open a report builder and select any of the
                columns to display the data in your report. For example, group
                tasks by project showing members, reported time and original
                estimates. Or you can build a report with the total involvement
                of a specific department. Use this data to keep your customer
                informed and to make sure that your team moves according to your
                original estimates. By increasing transparency in the
                development process, you will increase the number of your
                satisfied customers.
              </Text>
