export let AsanaQuestionData = [
  {
    title: "Is Everhour easy to connect with Asana?",
    detail:
    ...
    title: "How does Everhour for ClickUp work?",
    detail:
    ...
    title: "Why choose Everhour for time tracking in ClickUp?",
    detail:
    ...
    title: "What if not all my ClickUp users need time tracking?",
    detail:
    ...
    title: "Will someone else (like clients) see my time?",
    detail:
      "Only those people who are a part of your Everhour team and installed our browser extension can see time-related data in ClickUp.",
  },{
    title: "Does Everhour work on ClickUp native apps?",
    detail:
